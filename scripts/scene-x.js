    ...
    Draw() {
        ...
        if (!this.transition.IsComplete()) {
            if (this.introText) {
                ...
                const centeredText = CenterText(this.introText, 17, new Vector2(CANVAS_WIDTH, CANVAS_HEIGHT));
                DrawText(this.introText, centeredText.x, centeredText.y, 'normal 30px "Poiret One", sans-serif', '#FFFFFF');
            }
